...
___
  ...
  sub encrypt_by_four {
    ...
    $code .= "vbroadcasti32x4 16*10($key1), $tmp\n";
...
___
  ...
  # ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  # ;void aesni_xts_128_encrypt_avx512(
...
___
    ...
    encrypt_by_eight_zmm("%zmm1", "%zmm2", "%zmm9", "%zmm10", "%zmm0", 1, $is_256);
...
___
    ...
    encrypt_initial("%xmm1", "%xmm2", "%xmm3", "%xmm4", "%xmm5", "%xmm6",
                    ...
                    "%xmm13", "%xmm14", "%xmm15", "%xmm0", 3, 1, $is_256);
...
___
    ...
    encrypt_initial("%xmm1", "%xmm2", "%xmm3", "%xmm4", "%xmm5", "%xmm6",
                    "%xmm7", "%xmm8", "%xmm9", "%xmm10", "%xmm11", "%xmm12",
                    "%xmm13", "%xmm14", "%xmm15", "%xmm0", 2, 1, $is_256);
...
___
    ...
    encrypt_initial("%xmm1", "%xmm2", "%xmm3", "%xmm4", "%xmm5", "%xmm6",
                    "%xmm7", "%xmm8", "%xmm9", "%xmm10", "%xmm11", "%xmm12",
                    "%xmm13", "%xmm14", "%xmm15", "%xmm0", 1, 1, $is_256);
    {
    $code .= <<___;
    vmovdqu 	 %xmm1,($output)
    add 	 \$0x10,$output
...
___
    ...
    encrypt_by_16_zmm("%zmm1", "%zmm2", "%zmm3", "%zmm4", "%zmm9",
                      "%zmm10", "%zmm11", "%zmm12", "%zmm0", 0, $is_256);
...
___
    ...
    encrypt_by_eight_zmm("%zmm1", "%zmm2", "%zmm9", "%zmm10", "%zmm0", 0, $is_256);
...
___
    ...
    encrypt_by_four("%zmm1", "%zmm9", "%zmm0", $is_256);
...
___
    ...
    encrypt_by_four("%ymm1", "%ymm9", "%ymm0", $is_256);
...
___
  ...
  # ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  # ;void aesni_xts_128_decrypt_avx512(
  # ;               const uint8_t *in,        // input data
  # ;               uint8_t *out,             // output data
  # ;               size_t length,            // sector size, in bytes
...
___
    ...
    decrypt_by_eight_zmm("%zmm1", "%zmm2", "%zmm9", "%zmm10", "%zmm0", 1, $is_256);
...
___
    ...
    decrypt_by_eight_zmm("%zmm1", "%zmm2", "%zmm9", "%zmm10", "%zmm0", 0, $is_256);
...
___
    ...
    decrypt_initial("%xmm1", "%xmm2", "%xmm3", "%xmm4", "%xmm5", "%xmm6",
                    "%xmm7", "%xmm8", "%xmm9", "%xmm10", "%xmm11", "%xmm12",
                    "%xmm13", "%xmm14", "%xmm15", "%xmm0", 7, 1, $is_256);
...
___
    ...
    decrypt_initial("%xmm1", "%xmm2", "%xmm3", "%xmm4", "%xmm5", "%xmm6",
                    "%xmm7", "%xmm8", "%xmm9", "%xmm10", "%xmm11", "%xmm12",
                    "%xmm13", "%xmm14", "%xmm15", "%xmm0", 6, 1, $is_256);
...
___
    ...
    decrypt_initial("%xmm1", "%xmm2", "%xmm3", "%xmm4", "%xmm5", "%xmm6",
                    "%xmm7", "%xmm8", "%xmm9", "%xmm10", "%xmm11", "%xmm12",
                    "%xmm13", "%xmm14", "%xmm15", "%xmm0", 5, 1, $is_256);
...
___
    ...
    decrypt_initial("%xmm1", "%xmm2", "%xmm3", "%xmm4", "%xmm5", "%xmm6",
                    "%xmm7", "%xmm8", "%xmm9", "%xmm10", "%xmm11", "%xmm12",
                    "%xmm13", "%xmm14", "%xmm15", "%xmm0", 4, 1, $is_256);
